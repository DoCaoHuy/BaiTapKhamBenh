...
namespace BTKhamBenh
{
    public partial class frmThongTin : Form
    {
        ...
        private void consumer_listener(IMessage message)
        {
            ...
            {
                string messtext = (message as ActiveMQTextMessage).Text;
                Console.WriteLine(messtext);
                if (txtCMND.InvokeRequired)
                {
                    txtCMND.Invoke((MethodInvoker)(() => txtCMND.AppendText(messtext + "\n")));
                }
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (objBenhNhan.getBNBietMa(txtMa.Text) != null)
            {
                ...
                {
                    MessageBox.Show("Trung CMND");
                }
                else
                {
                    //Random r = new Random();
                    //int[] so={001,002,003};
                    //them vao DS benh nhan
